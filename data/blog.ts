...
export const blogPosts: BlogPost[] = [
  {
    ...
    featuredImage: "/images/nextjs-intro.jpg",
    author: {
      name: "John Doe",
      bio: "Web developer and Next.js enthusiast.",
      profileImage: "/images/authors/john-doe.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/nextjs-intro.jpg",
  ...
  },
  {
    ...
    featuredImage: "/images/tailwindcss-guide.jpg",
    author: {
      name: "Jane Smith",
      bio: "UI/UX designer and TailwindCSS aficionado.",
      profileImage: "/images/authors/jane-smith.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/tailwindcss-guide.jpg",
  ...
  },
  {
    ...
    author: {
      ...
      profileImage: "/images/authors/chris-evans.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/framer-motion.jpg",
  ...
  },
  {
    ...
    featuredImage: "/images/typescript-guide.jpg",
    author: {
      name: "Alice Johnson",
      bio: "Software engineer and TypeScript advocate.",
      profileImage: "/images/authors/alice-johnson.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/typescript-guide.jpg",
  ...
  },
  {
    ...
    author: {
      ...
      profileImage: "/images/authors/emma-wilson.jpg",
      socialLinks: {
  ...
  },
  {
    ...
    author: {
      ...
      profileImage: "/images/authors/lucas-martin.jpg",
      socialLinks: {
  ...
  },
  {
    ...
    featuredImage: "/images/flexbox.jpg",
    author: {
      name: "Mia Taylor",
      bio: "Frontend developer and Flexbox specialist.",
      profileImage: "/images/authors/mia-taylor.jpg",
      socialLinks: {
  ...
  },
  {
    ...
    featuredImage: "/images/pwa-nextjs.jpg",
    author: {
      name: "Ethan Scott",
      bio: "Full-stack developer with a focus on PWAs.",
      profileImage: "/images/authors/ethan-scott.jpg",
      socialLinks: {
  ...
  },
  {
    ...
    featuredImage: "/images/ssr-react.jpg",
    author: {
      name: "Sophia Clark",
      bio: "React developer and SSR advocate.",
      profileImage: "/images/authors/sophia-clark.jpg",
      socialLinks: {
  ...
  },
  {
    ...
    featuredImage: "/images/custom-hooks.jpg",
    author: {
      name: "Charlotte Adams",
      bio: "React developer specializing in custom hooks.",
      profileImage: "/images/authors/charlotte-adams.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/custom-hooks.jpg",
  ...
  },
  {
    ...
    featuredImage: "/images/web-performance.jpg",
    author: {
      name: "David Wilson",
      bio: "Web performance specialist and optimization expert.",
      profileImage: "/images/authors/david-wilson.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/web-performance.jpg",
  ...
  },
  {
    ...
    author: {
      ...
      profileImage: "/images/authors/ethan-davis.jpg",
      socialLinks: {
  ...
  },
  {
    ...
    featuredImage: "/images/static-site-generator.jpg",
    author: {
      name: "Olivia Moore",
      bio: "Web developer with a passion for static site generators.",
      profileImage: "/images/authors/olivia-moore.jpg",
      socialLinks: {
    ...
    seo: {
      ...
      ogImage: "/images/static-site-generator.jpg",
