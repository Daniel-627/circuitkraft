    ...
    <footer className="bg-gray-50 dark:bg-[#192428] text-gray-800 dark:text-white py-8">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <p>Email: <a href="mailto:your-email@example.com" className="text-blue-400 dark:text-green-400">your-email@example.com</a></p>
          <p>Phone: <span className="text-gray-400">+123 456 7890</span></p>

          {/* Social Links */}
          <div className="flex space-x-4">
            <a href="https://x.com" target="_blank" rel="noopener noreferrer" className="text-2xl text-black dark:text-white hover:text-blue-500 dark:hover:text-green-400">
              <FaXTwitter />
            </a>
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-2xl text-black dark:text-white hover:text-red-500">
              <FaYoutube />
            </a>
          </div>
        </div>
