...
export default function RandomCategory1() {
  ...
  return (
    <Link href={`/blog/${post.slug.current}`} passHref key={post._id}>
      <div
        className="relative h-72 bg-cover bg-center rounded-lg shadow-lg cursor-pointer dark:bg-[#192428] dark:hover:bg-gray-700"
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-4 z-10 text-white">
          ...
          <h2 className="text-lg font-medium mt-2 hover:underline">{post.title}</h2>
